        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5"><strong>†Admiral_Fujitora†</strong></h6>
                ...
                <div class="widget-holder widget-full-height widget-flex col-lg-6">
                    <div class="widget-bg">
                        <div class="widget-heading">
                            <h5 class="widget-title">[⍋] Gringas </h5>
                        ...
                        <div class="widget-body">
                            <div class="container-fluid pd-20">
                                <div class="row">
                                    ...
                                    <p>Edited By :  <a target="_BLANK" href="https://telegram.me/reboot13/">
                                    Matthew ♛</a></p>
